    ...
    <jsp:include page="/WEB-INF/views/common/header.jsp" />
        <section class="signUp-content">
            <form action="/member/signUp" method="POST" name="signUp-frm" id="signUp-frm">
                ...
                <div class="signUp-input-area">
                    <input type="text" name="authKey" id="authKey" placeholder="인증번호" 
                    maxlength="6" autocomplete="off" required>
                    <button id="checkAuthKeyBtn" type="button">인증 하기</button>
                </div>
                ...
                <span class="signUp-message" id="pwMessage">영어,숫자,특수문자(!,@,#,-,_) 6~20 사이로 입력해주세요.</span>
                ...
                <div class="signUp-input-area">
                    ...
                    maxlength="10" autocomplete="off" required value="${tempMember.memberNickname}">
                </div>
                ...
                <div class="signUp-input-area">
                    <input type="text" name="memberAddress" id="sample6_address" placeholder="도로명/지번주소" value="${addr[1]}">
                </div>
                <div class="signUp-input-area">
                    <input type="text" name="memberAddress" id="sample6_detailAddress" placeholder="상세주소" value="${addr[2]}">
                </div>
